...
//		Y
	SiPM(2,   1,    0,  5, 1,  5.7, 4.0);
	SiPM(2,   2,    0,  5, 2,  5.7, 4.0);
	SiPM(2,   3,    0,  5, 3,  5.7, 4.0);
	SiPM(2,   4,    0,  5, 4,  5.7, 4.0);
	SiPM(5,   1,    0,  5, 5,  4.1, 4.0);
	SiPM(5,   2,    0,  5, 6,  4.1, 4.0);
	SiPM(5,   3,    0,  5, 7,  4.1, 4.0);
	SiPM(5,   4,    0,  5, 8,  4.1, 4.0);
	SiPM(6,   1,    0,  5, 9,  3.5, 4.0);
	SiPM(6,   2,    0,  5, 10, 3.5, 4.0);
	SiPM(6,   3,    0,  5, 11, 3.5, 4.0);
	SiPM(6,   4,    0,  5, 12, 3.5, 4.0);
	SiPM(7,   1,    0,  5, 13, 2.6, 4.0);
	SiPM(7,   2,    0,  5, 14, 2.6, 4.0);
	SiPM(7,   3,    0,  5, 15, 2.6, 4.0);
	SiPM(7,   4,    0,  5, 16, 2.6, 4.0);
	SiPM(8,   1,    0,  5, 17, 2.4, 4.0);

	SiPM(8,   2,    0,  4, 1,  2.4, 4.0);
	SiPM(8,   3,    0,  4, 2,  2.4, 4.0);
	SiPM(8,   4,    0,  4, 3,  2.4, 4.0);
	SiPM(9,   1,    0,  4, 4,  1.3, 4.0);
	SiPM(9,   2,    0,  4, 5,  1.3, 4.0);
	SiPM(9,   3,    0,  4, 6,  1.3, 4.0);
	SiPM(9,   4,    0,  4, 7,  1.3, 4.0);
	...
	SiPM(24,  1,    0,  1, 1, -1.2, 4.0);
	SiPM(24,  2,    0,  1, 2, -1.2, 4.0);
	SiPM(24,  3,    0,  1, 3, -1.2, 4.0);
	SiPM(24,  4,    0,  1, 4, -1.2, 4.0);
...
//		X
	SiPM(26,  1,    1,  1, 1, -0.6, 4.0);
	SiPM(26,  2,    1,  1, 2, -0.6, 4.0);
	SiPM(26,  3,    1,  1, 3, -0.6, 4.0);
	SiPM(26,  4,    1,  1, 4, -0.6, 4.0);
	SiPM(27,  1,    1,  1, 5,  3.2, 4.0);
	SiPM(27,  2,    1,  1, 6,  3.2, 4.0);
	SiPM(27,  3,    1,  1, 7,  3.2, 4.0);
	SiPM(27,  4,    1,  1, 8,  3.2, 4.0);
	SiPM(28,  4,    1,  1, 9,  2.8, 4.0);	// !
	SiPM(28,  1,    1,  1, 10, 2.8, 4.0);
	SiPM(28,  2,    1,  1, 11, 2.8, 4.0);
	SiPM(28,  3,    1,  1, 12, 2.8, 4.0);
